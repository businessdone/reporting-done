...
async def create_project_endpoint(
    ...
    result = await project_service.create(dto, session)
...
async def get_project_endpoint(
    ...
    result = await project_service.get_by_id(project_id, session)
...
async def update_project_endpoint(
    ...
    result = await project_service.update(project_id, dto, session)
...
async def delete_project_endpoint(
    ...
    result = await project_service.delete(project_id, session)
...
async def assign_user_endpoint(
    project_id: str,
    ...
    result = await project_service.assign_user(project_id, body.user_id, session)
...
async def remove_user_endpoint(
    ...
    result = await project_service.remove_user(project_id, body.user_id, session)
...
async def get_project_users_endpoint(
    ...
    result = await project_service.get_project_users(project_id, pagination, session)
...
async def get_project_tasks_endpoint(
    ...
    pagination = PaginationParams(page=page, per_page=limit)
    result = await project_service.get_project_tasks(project_id, pagination, session)
